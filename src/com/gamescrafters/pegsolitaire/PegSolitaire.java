...
public class PegSolitaire extends GameActivity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setGameView(R.layout.pegsolitaire_game);
		myGUI = new GUIPegSolitaire(this,HEIGHT);
		
		Intent myIntent = GameIntent = getIntent();
		myBottomText = (TextView)findViewById(R.id.pegsolitaire_gameover);
	...
	public String getBoardString() {
		...
		for (int i=0; i < myBoard.length; i++) { //height
				...
				if (currentElem == PegSolitaire.RED)
					board.append("O");
				else if (currentElem == PegSolitaire.BLUE)
					board.append("X");
				else
					board.append("%20");
		}
